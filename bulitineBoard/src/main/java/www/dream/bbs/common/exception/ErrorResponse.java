...
public class ErrorResponse {
    ...
    private ErrorCode buisinessExceptionError;
    private String message;
    
    public static ErrorResponse of(ErrorCode buisinessExceptionError, String message) {
        return new ErrorResponse(buisinessExceptionError, message);
    }
